...
module.exports = async (ctx, next) => {
  var data = ctx.query;
  var date = new Date();
  var x = await DB('company').insert({ company_id: data.company_id, company_name: data.company_name, company_type: data.company_type, company_address: data.company_address,  company_state: '未认证',company_time: date });
  var result='注册成功';
